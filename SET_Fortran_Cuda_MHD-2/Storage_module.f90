...
module STORAGE 
    ...
    subroutine Set_Storage()
        ...
        open(1, file = "FCMHD_4-2.bin", FORM = 'BINARY', ACTION = "READ")
    ...
    subroutine Save_Storage()
        ...
        open(newunit=unit, file="FCMHD_4.3-2_out.bin", form='unformatted', access='stream', &
    ...
    subroutine Fill_data()
        ...
        ! Открываем файл для записи в бинарном формате
        open(3, file = "FCMHD_4.3_out.bin", FORM = 'BINARY', ACTION = "READ")
